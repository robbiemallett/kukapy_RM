extract_config = {
    ...
    "sub_bandwidth":2000, #bandwidth of sub-band in MHz
    "sub_center_frequency":33000.0, #center frequency of sub-band in MHz
    ...
    "raw_data_path":"//home/robbie/Dropbox/Defiant/kuka_data/testing/raw/", #data file path for location of raw data
    "processed_data_path": "/home/robbie/Dropbox/Defiant/kuka_data/testing/processed/",     #data file path for location of processed data  
    "show_all_plot" : 0,
}
